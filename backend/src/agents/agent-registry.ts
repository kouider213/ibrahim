...
- "passeport de X" / "document de X" / "numéro de X" / "envoie le passeport de X":
  ...
  ÉTAPE 2: get_client_document envoie automatiquement le document dans le chat (Socket.IO) — rien d'autre à faire.
  ÉTAPE 3: confirmer: "✅ J'ai envoyé le passeport de X dans le chat"
  ⚠️ JAMAIS appeler send_telegram_message pour les documents — le chat affiche directement les images.
