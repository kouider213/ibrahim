...
import cashRoutes          from './api/routes/cash.js';
import reviewsRoutes       from './api/routes/reviews.js';
import blogRoutes          from './api/routes/blog.js';
import whatsappDraftRoutes from './api/routes/whatsapp-draft.js';
...
import quoteRoutes         from './api/routes/quote.js';
import voucherRoutes       from './api/routes/reservation-voucher.js';
...
app.use('/api/cash',          apiLimiter, cashRoutes);
app.use('/api/reviews',       apiLimiter, reviewsRoutes);
app.use('/api/blog',          apiLimiter, blogRoutes);
app.use('/api/whatsapp',      apiLimiter, whatsappDraftRoutes);
...
app.use('/api/reservation-voucher', apiLimiter, voucherRoutes);
