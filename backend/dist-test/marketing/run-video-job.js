...
exports.triggerMarketingVideo = triggerMarketingVideo;
...
async function notifyTelegram(chatId, msg) {
    try {
 ...
 */
async function triggerMarketingVideo(input, chatId) {
    ...
    await notifyTelegram(targetChatId, [
    ...
    const result = await (0, create_marketing_video_js_1.executeCreateMarketingVideo)(input, targetChatId);
...
//# sourceMappingURL=run-video-job.js.map