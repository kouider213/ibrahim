...
exports.saveVideoProject = saveVideoProject;
exports.getLatestVideoProject = getLatestVideoProject;
exports.updateVideoProject = updateVideoProject;
exports.buildClientSearchStoryboard = buildClientSearchStoryboard;
exports.buildAirportArrivalStoryboard = buildAirportArrivalStoryboard;
exports.buildFleetRevealStoryboard = buildFleetRevealStoryboard;
exports.buildCornicheDriveStoryboard = buildCornicheDriveStoryboard;
const _projects = new Map();
let _latestId = null;
function saveVideoProject(project) {
...
function getLatestVideoProject() {
    if (!_latestId)
        return null;
    return _projects.get(_latestId) ?? null;
}
function updateVideoProject(id, patch) {
    const p = _projects.get(id);
    if (p)
        Object.assign(p, patch);
}
function buildClientSearchStoryboard(carName, priceDisplay, whatsappNumber = '+213 XX XX XX XX') {
    return {
...
function buildAirportArrivalStoryboard(carName, priceDisplay, whatsappNumber = '+213 XX XX XX XX') {
    return {
...
function buildFleetRevealStoryboard(carName, priceDisplay) {
    return {
...
function buildCornicheDriveStoryboard(carName, priceDisplay) {
    return {
...
//# sourceMappingURL=video-project-store.js.map