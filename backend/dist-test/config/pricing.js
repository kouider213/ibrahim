...
exports.VEHICLE_PRICING = void 0;
exports.getPricingForVehicle = getPricingForVehicle;
exports.formatPricingTable = formatPricingTable;
exports.VEHICLE_PRICING = [
    ...
    { name: 'Clio 4 v1', houariPrice: 16, kouiderPrice: 25, benefit: 9 },
    { name: 'Clio 4 v2', houariPrice: 24, kouiderPrice: 35, benefit: 11 },
    { name: 'i10', houariPrice: 16, kouiderPrice: 25, benefit: 9 },
...
function getPricingForVehicle(vehicleName) {
    const name = vehicleName.toLowerCase();
    return exports.VEHICLE_PRICING.find(p => name.includes(p.name.toLowerCase()) || p.name.toLowerCase().includes(name));
}
function formatPricingTable() {
    return exports.VEHICLE_PRICING.map(p => `${p.name.padEnd(14)} | Houari: ${p.houariPrice}€ | Kouider: ${p.kouiderPrice}€ | Bénéfice: ${p.benefit}€`).join('\n');
}
