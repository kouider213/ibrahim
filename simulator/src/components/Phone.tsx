    ...
    <div style={{
      ...
      {powering && (
        <div style={{
          ...
          <div style={{ fontFamily: 'Orbitron', fontSize: 10, color: '#6366f144', letterSpacing: '0.3em' }}>
            DÉCONNEXION…
          </div>
        </div>
      )}
      ...
      {notif && simState === 'app' && (
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: 'Orbitron', fontSize: 7, color: '#6366f1', letterSpacing: '0.15em', marginBottom: 2 }}>
              DZARYX
            </div>
          ...
          {notif.deepLink && (
            <button
              ...
              style={{
                ...
                fontFamily: 'Orbitron', fontSize: 6, color: '#6366f1', letterSpacing: '0.12em',
                flexShrink: 0,
              }}
            >
              VOIR
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 32, zIndex: 1 }}>
        ...
        <div style={{
          ...
          color: 'rgba(99,102,241,0.4)', letterSpacing: '0.3em',
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', paddingTop: 24, zIndex: 1 }}>
        <div style={{ fontFamily: 'Orbitron', fontSize: 40, fontWeight: 700, color: '#fff', textShadow: '0 0 24px rgba(99,102,241,0.2)' }}>
          {getTime()}
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
            <div style={{ position: 'relative' }}>
              ...
              <div style={{
                ...
                boxShadow: '0 0 30px rgba(99,102,241,0.3), 0 0 60px rgba(99,102,241,0.1), 0 8px 32px rgba(0,0,0,0.6)',
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: 'Inter', fontSize: 10, color: 'rgba(99,102,241,0.5)', marginTop: 3, letterSpacing: '0.08em' }}>
    ...
    <div style={{
      ...
      <div style={{ zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32, width: '100%', maxWidth: 360, animation: 'fadeUp 0.5s ease both' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            <div style={{ fontFamily: 'Orbitron', fontSize: 22, fontWeight: 900, color: '#6366f1', letterSpacing: '0.4em', textShadow: '0 0 20px rgba(99,102,241,0.4)', textAlign: 'center' }}>
              DZARYX
            </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <label style={{ fontFamily: 'Inter', fontSize: 10, fontWeight: 600, color: 'rgba(99,102,241,0.5)', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
              Identifiant
            </label>
            <input
              value={user}
          ...
          <button
            ...
            style={{
              ...
              background: loading ? 'rgba(99,102,241,0.12)' : (!user || !pass ? 'rgba(99,102,241,0.06)' : 'linear-gradient(135deg, rgba(99,102,241,0.18) 0%, rgba(0,180,220,0.12) 100%)'),
              border: `1.5px solid ${!user || !pass ? 'rgba(99,102,241,0.15)' : 'rgba(99,102,241,0.45)'}`,
              borderRadius: 14,
              fontFamily: 'Orbitron', fontSize: 11, fontWeight: 700, color: !user || !pass ? 'rgba(99,102,241,0.3)' : '#6366f1',
              cursor: loading || !user || !pass ? 'default' : 'pointer',
              letterSpacing: '0.2em',
              boxShadow: !user || !pass ? 'none' : '0 0 20px rgba(99,102,241,0.2)',
  ...
  return (
    <img
      ...
      style={{
        ...
        filter: glow ? 'drop-shadow(0 0 14px rgba(99,102,241,0.45)) drop-shadow(0 0 30px rgba(99,102,241,0.18))' : undefined,
      }}
    />
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Brand */}
        <span style={{ fontFamily: 'Orbitron', fontSize: 10, fontWeight: 700, color: 'rgba(99,102,241,0.55)', letterSpacing: '0.2em' }}>
          DZARYX
        </span>
        ...
        <div style={{
          ...
          background: wsOk ? 'rgba(99,102,241,0.06)' : 'rgba(255,51,102,0.06)',
          border: `1px solid ${wsOk ? 'rgba(99,102,241,0.18)' : 'rgba(255,51,102,0.2)'}`,
        }}>
          <div style={{
            width: 5, height: 5, borderRadius: '50%',
            background: wsOk ? '#6366f1' : '#ff3366',
            boxShadow: `0 0 6px ${wsOk ? '#6366f1' : '#ff3366'}`,
            animation: 'statusPulse 2s ease infinite',
          }} />
          <span style={{ fontFamily: 'Inter', fontSize: 11, fontWeight: 600, color: wsOk ? 'rgba(99,102,241,0.85)' : '#ff3366', letterSpacing: '0.06em' }}>
...
function NavBar({ page, onPage, actor }: { page: Page; onPage: (p: Page) => void; actor: string }) {
  ...
  const actorAccent = actor === 'houari' ? '#7c3aed' : '#6366f1';
  return (
    <div style={{
      width: '100%',
