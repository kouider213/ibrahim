...
const MESSAGES: Record<string, TgMsg[]> = {
  all: [
    ...
    },
    {
      ...
      tag: '📊 RAPPORT MAI 2026', tagCol: '#10b981',
  ...
  finance: [
    ...
    },
    {
      ...
      tag: '📊 BILAN JOURNÉE', tagCol: '#10b981',
  ...
  resas: [
    {
      ...
      tag: '📋 ÉTAT DU PARC', tagCol: '#10b981',
  ...
  promo: [
    ...
    },
    {
      ...
      tag: '📊 VEILLE CONCURRENTS', tagCol: '#10b981',
    ...
    return (
      <div style={{ textAlign: 'center', padding: '4px 0' }}>
        <span style={{
          ...
          {msg.tag && <span style={{ color: msg.tagCol ?? '#10b981' }}>{msg.tag} · </span>}
          {msg.text}
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 7 }}>
      ...
      <div style={{ maxWidth: '78%', display: 'flex', flexDirection: 'column', gap: 2 }}>
        {/* Name */}
        <div style={{ fontSize: 9, color: '#10b981', fontWeight: 600, marginLeft: 1 }}>Dzaryx</div>
        ...
        <div style={{
          ...
          {msg.tag && (
            <div style={{
              fontFamily: 'Inter, sans-serif', fontSize: 8, color: msg.tagCol ?? '#10b981',
              fontWeight: 700, letterSpacing: '0.08em', marginBottom: 5,
              borderLeft: `2px solid ${msg.tagCol ?? '#10b981'}`,
              paddingLeft: 6,
            }}>
              {msg.tag}
            </div>
          ...
          {msg.photo && (
            <div style={{
              ...
              {msg.type === 'file' && (
                <div style={{ fontSize: 8, color: '#10b98144', marginTop: 4, fontFamily: 'Inter, sans-serif' }}>
                  📎 DOCUMENT
                </div>
              )}
            </div>
