              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSel ? '#6366f118' : isToday ? '#6366f10a' : hasAny ? '#ffffff05' : 'transparent',
                    border: isSel ? '1px solid #6366f155' : isToday ? '1px solid #6366f133' : '1px solid transparent',
