  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: '#020810', color: '#fff', fontFamily: 'Share Tech Mono', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '8px 14px 6px', borderBottom: '1px solid #6366f112', flexShrink: 0, background: 'rgba(2,8,16,0.97)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          ...
          <div style={{ flex: 1, textAlign: 'center' }}>
            <span style={{ fontFamily: 'Orbitron', fontSize: 9, color: '#6366f1', letterSpacing: '0.15em' }}>
            ...
            {!isAtNow && (
              <button onClick={goToNow} style={{ marginLeft: 8, background: '#6366f118', border: '1px solid #6366f144', borderRadius: 4,
                fontFamily: 'Orbitron', fontSize: 6, color: '#6366f1aa', cursor: 'pointer', padding: '2px 6px' }}>
                ↩ CE MOIS
              </button>
            )}
          </div>
        ...
        <div style={{ display: 'flex', gap: 4 }}>
          {([
            ...
            <button key={t.id} onClick={() => setTab(t.id)} style={{
              ...
              fontFamily: 'Orbitron', fontSize: 6, color: tab === t.id ? '#6366f1' : '#ffffff33',
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '8px 12px', display: 'flex', flexDirection: 'column', gap: 8 }}>
        {report?.dzd && (isHouari || report.dzd.bookings > 0) && (
          <div style={{ borderRadius: 12, border: '1px solid #6366f144', background: 'linear-gradient(135deg, rgba(99,102,241,0.10), rgba(2,8,16,0.6))', padding: '11px 13px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              <span style={{ fontFamily: 'Orbitron', fontSize: 8, color: '#6366f1', letterSpacing: '0.15em' }}>💱 CA EN DINARS (HOUARI)</span>
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: 30, fontFamily: 'Orbitron', fontSize: 9, color: '#6366f133', letterSpacing: '0.25em' }}>
            CHARGEMENT…
          </div>
        ) : tab === 'overview' ? (
          <OverviewTab
  ...
  return (
    <>
      ...
      <div style={{ textAlign: 'center', background: 'rgba(99,102,241,0.05)', borderRadius: 12, padding: '14px', border: '1px solid #6366f11a' }}>
        <div style={{ fontSize: 7, color: '#6366f155', letterSpacing: '0.25em', fontFamily: 'Orbitron', marginBottom: 4 }}>CA TOTAL</div>
        <div style={{ fontFamily: 'Orbitron', fontSize: 32, color: '#6366f1', textShadow: '0 0 20px #6366f155' }}>
          {fmt(caMonth)}
        </div>
...
function AnnualTab({ report, year, fmt }: {
  ...
  return (
    <>
      {/* Year header */}
      <div style={{ textAlign: 'center', fontFamily: 'Orbitron', fontSize: 9, color: '#6366f155', letterSpacing: '0.3em', marginBottom: 2 }}>
        BILAN {year}
      </div>

      {/* Big annual CA */}
      <div style={{ textAlign: 'center', background: 'rgba(99,102,241,0.05)', borderRadius: 12, padding: '14px', border: '1px solid #6366f11a' }}>
        <div style={{ fontSize: 7, color: '#6366f144', letterSpacing: '0.25em', fontFamily: 'Orbitron', marginBottom: 4 }}>CA ANNUEL TOTAL</div>
        <div style={{ fontFamily: 'Orbitron', fontSize: 34, color: '#6366f1', textShadow: '0 0 20px #6366f155', lineHeight: 1 }}>
          {fmt(report.grossCA)}
        </div>
          ...
          {vehicles.map(([name, stats]) => (
            <div key={name} style={{ marginBottom: 9 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2, alignItems: 'center' }}>
                ...
                <span style={{ fontFamily: 'Orbitron', fontSize: 9, color: '#6366f1', flexShrink: 0, marginLeft: 8 }}>
                  {fmt(stats.ca)}
                </span>
              </div>
      ...
      {vehicles.map(([name, stats]) => (
        <div key={name} style={{ marginBottom: 8 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
            ...
            <span style={{ fontFamily: 'Orbitron', fontSize: 8, color: '#6366f1', flexShrink: 0, marginLeft: 8 }}>{fmt(stats.ca)}</span>
          </div>
